import { SiteSettings, Program, StatMetric, EventItem, Testimonial } from "../types/content.js";
...
export const siteSettingsSeed: SiteSettings = {
  ...
  contact: {
    ...
    address:
      "Vijayamangalam, Tiruppur - 638056, Tamil Nadu, India",
    mapEmbedUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3912...",
  },
  socialLinks: {
...
export const programSeed: Program[] = [
  {
    ...
    description:
      "AI-driven curriculum with research labs, hackathons, and product incubation support.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Industry-focused MBA with dual specialization and global immersion program.",
    highlights: [
...
export const statsSeed: StatMetric[] = [
...
export const eventsSeed: EventItem[] = [
  {
    ...
    excerpt:
      "48-hour prototype challenge with industry mentors across AI, EV, and MedTech tracks.",
    ctaLabel: "Register",
  ...
  },
  {
    ...
    location: "Virtual",
    excerpt:
      "Get clarity on eligibility, scholarships, and hostel facilities with the admissions team.",
...
export const testimonialsSeed: Testimonial[] = [
  {
    ...
    quote:
      "The mentorship and research exposure I received at Sasurie helped me ace product interviews with confidence.",
    category: "placement",
  },
  {
    name: "Arjun Balaji",
    ...
    quote:
      "Transparent communication and personalised academic support made my son's journey stress-free.",
