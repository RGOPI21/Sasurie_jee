...
export const sendApplicationConfirmationEmail = async (userEmail, userName, applicationData) => {
    try {
...
const generateApplicationSummaryHTML = (userName, appData) => {
    const { personalInfo, contactInfo, familyInfo, academicInfo, coursePreferences, reservationCategory, additionalDetails, } = appData;
    return `
    <!DOCTYPE html>
    <html>
    <head>
